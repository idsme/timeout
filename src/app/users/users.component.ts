...
export class UsersComponent implements OnInit {
  ...
  public userConfigForm = this.setupFormBuilderFormControls();
    ...
    constructor(public masterDataService: MasterDataService, public usersService: LocalStorageService, public fb: FormBuilder) {
  }
  ...
  ngOnInit() {
    this.masterDataService.getUser().subscribe((data: User) => {
      this.userAppConfig = data;
        ...
        this.usersService.addUserConfigToLocalStorage(data);
